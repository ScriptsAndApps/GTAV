...
subb:add_action("F6 > Get in your PV vehicle", function() end)
...
local carteleFSIX=117			--	TelePort IN PERSONAL VEHICLE
...
local function TelePortinpv(e)
	menu:enter_personal_vehicle()
end


menu.register_hotkey(carteleFSIX, TelePortinpv)
